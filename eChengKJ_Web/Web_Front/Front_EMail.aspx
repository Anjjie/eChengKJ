...
<asp:Content ID="Content2" ContentPlaceHolderID="pansonelContent_JS" runat="server">
    <script src="js/Front_EMail.js"></script>
    ...
    <div class="Pansonel_leftDiv_sonDiv">
        ...
        <ul class="Pansonel_leftDiv_sonDiv_ul">
            ...
            <div id="sonShowDiv2" class="Pansonel_leftDiv_sonDiv_li_div" style="margin: 0; float: left;">
                <div  id="myInfo"  class="Pansonel_leftDiv_sonDiv_li_div">邮箱绑定</div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="pansonelContent_Right" runat="server">
   <div class="view-SetOrUpdaet">
       <div class="pwdTop">
           <div class="left">
               <div class="topLeftAdorn"></div>邮箱绑定
           </div>
           <div class="right">
               <div class="step">完成</div>
               <div class="step">3.设置新邮箱</div>
       ...
       <div class="pwdBottom">
           <div class="pwdContent">
               ...
               <div name="content-view" >
                   <div id="set_email">
                       <div style="margin-right:10px;width:45%;text-align:right;color:#999999;">电子邮箱</div>
                       <div ><input id="txtEmail" type="text" placeholder="新电子邮箱" /></div>
                   </div>
                   <div id="emailOk">
                       <div style="margin-right:10px;width:45%;text-align:right;color:#999999;">重复输入</div>
                       <div><input id="txtEmailOk" type="text" placeholder="再次确认电子邮箱" /> </div>
                   </div>
               </div>
               <div name="content-view" >
                   <label style="font-size:15pt;font-weight:600;">请阅读以下相关信息</label>
                        <br /><br />
                        完成后将有一封电子邮箱发送到您新绑定的邮箱中，请点击进行邮箱激活！
                       <br /><br />点击[完成]按钮，将结束本次新邮箱绑定！
                       <br /><br />温馨提示：24小时内为完成激活本次邮箱视为作废处理并且在未来三天中不得在进行邮箱绑定！
                       <br /><br />
               </div>
           </div>
           <div> 

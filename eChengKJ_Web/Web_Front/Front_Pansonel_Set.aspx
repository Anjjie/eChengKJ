<%@ Page Title="" Language="C#" MasterPageFile="~/Web_Front/Front_Pansonel.master" AutoEventWireup="true" CodeBehind="Front_Pansonel_Set.aspx.cs" Inherits="eChengKJ_Web.Web_Front.Front_Pansonel_Set" %>
<%-- CSS样式文件及样式类 --%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="pansonelContent_JS" runat="server">
    <script type="text/javascript">
        ...
        var defaultColorId = "#img6";//设置左边导航栏默认图片及文字颜色
        var imgId;//图片ID
        var defaultId = "#img6_0";//默认图片的ID地址选项中
     ...
     <div class="Pansonel_leftDiv_sonDiv">
                ...
                <ul class="Pansonel_leftDiv_sonDiv_ul">
                     <li class="Pansonel_leftDiv_sonDiv_li" id="ShowDiv0"> 
                         <a href="javasrcipt:;" style="color:#808080;font-size:10pt;">
                             <div class="Pansonel_leftDiv_sonDiv_div"></div>账号设置</a>
                     </li>
                  <div id="sonShowDiv0" class="Pansonel_leftDiv_sonDiv_li_div" style="margin:0;float:left;">
                             <div class="Pansonel_leftDiv_sonDiv_li_div">退出登陆</div>
                             <div class="Pansonel_leftDiv_sonDiv_li_div">登陆设置</div>
                  </div>
                </ul>
                ...
                <ul class="Pansonel_leftDiv_sonDiv_ul">
                      ...
                      <div id="sonShowDiv2" class="Pansonel_leftDiv_sonDiv_li_div" style="margin:0;float:left;">
                             <div class="Pansonel_leftDiv_sonDiv_li_div">密保</div>
                             <div class="Pansonel_leftDiv_sonDiv_li_div">手机</div>
                             <div class="Pansonel_leftDiv_sonDiv_li_div">邮箱</div>
                         </div>
                 </ul>
             </div>
</asp:Content>
